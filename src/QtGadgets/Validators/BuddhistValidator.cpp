...
N::BuddhistValidator:: BuddhistValidator ( QObject * parent )
                     : QValidator        (           parent )
                     , Validator         (           parent )
{
  Keywords [ 0 ] = tr ( "B.E."     ) ;
...
N::BuddhistValidator::~BuddhistValidator (void)
{
}

int N::BuddhistValidator::Type(void) const
{
  return 10000 + Calendars::Buddhist ;
}

void N::BuddhistValidator::Fixup(QString & input) const
{
  fixup(input) ;
}

QLocale N::BuddhistValidator::Locale(void) const
{
  return QValidator::locale() ;
}

void N::BuddhistValidator::setLocale (const QLocale & locale)
{
  QValidator::setLocale(locale) ;
}

QValidator::State N::BuddhistValidator::isValid(QString & input,int & pos) const
{
...
QValidator::State N::BuddhistValidator::validate(QString & input,int & pos) const
{
