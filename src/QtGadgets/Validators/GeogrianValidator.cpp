...
N::GeogrianValidator:: GeogrianValidator ( QObject * parent )
                     : QValidator        (           parent )
                     , Validator         (           parent )
{
  Keywords [ 0 ] = tr ( "C.E."     ) ;
...
N::GeogrianValidator::~GeogrianValidator (void)
{
}

int N::GeogrianValidator::Type(void) const
{
  return 10000 + Calendars::Geogrian ;
}

void N::GeogrianValidator::Fixup(QString & input) const
{
  fixup(input) ;
}

QLocale N::GeogrianValidator::Locale(void) const
{
  return QValidator::locale() ;
}

void N::GeogrianValidator::setLocale (const QLocale & locale)
{
  QValidator::setLocale(locale) ;
}

QValidator::State N::GeogrianValidator::isValid(QString & input,int & pos) const
{
...
QValidator::State N::GeogrianValidator::validate(QString & input,int & pos) const
{
