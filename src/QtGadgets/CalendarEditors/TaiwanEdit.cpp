...
#ifdef WIN32
#pragma message("Taiwan calendar editor are required to do a check on leap years")
#else
#warning        "Taiwan calendar editor are required to do a check on leap years"
#endif

N::TaiwanEdit:: TaiwanEdit       ( QWidget * parent           )
              : CalendarTimeEdit (           parent           )
              , validator        ( new TaiwanValidator (this) )
{
...
N::TaiwanEdit::~TaiwanEdit(void)
{
}

QAbstractSpinBox::StepEnabled N::TaiwanEdit::stepEnabled(void) const
{
  return StepUpEnabled | StepDownEnabled ;
}

void N::TaiwanEdit::setRange(TimePeriod period)
{
  Range.L = period.L              ;
  Range.R = period.R              ;
  /////////////////////////////////
...
TUID N::TaiwanEdit::currentStardate(void)
{
  return Time . Stardate ;
}

bool N::TaiwanEdit::setStardate(TUID sd)
{
  Time . assign ( sd ) ;
  setTimeText   (    ) ;
  return true          ;
...
void N::TaiwanEdit::setTimeZone(int gmt)
{
  TimeZone = gmt ;
}

void N::TaiwanEdit::Adjustment(int year,int month,int mdays)
{
  TaiwanCalendar NX                      ;
  TUID           TT                      ;
  TUID           TS                      ;
...
bool N::TaiwanEdit::isLeap(int year)
{
  bool leap = false                               ;
  bool bc   = false                               ;
  int  ym                                         ;
...
void N::TaiwanEdit::AdjustDateTime(int year,int month,int mdays,int item)
{
  FixupDateTime ( year , month , mdays , item ) ;
}

void N::TaiwanEdit::stepBy(int steps)
{
  QLineEdit * le = lineEdit ( )             ;
  if (IsNull(le)) return                    ;
  QString s                                 ;
...
QValidator::State N::TaiwanEdit::validate (QString & input,int & pos) const
{
  return validator -> validate ( input , pos ) ;
}

void N::TaiwanEdit::setTimeText(void)
{
  QLineEdit * le = lineEdit ( )         ;
  if (IsNull(le)) return                ;
  le -> blockSignals ( true           ) ;
  le -> setText      ( TaiwanString() ) ;
  le -> blockSignals ( false          ) ;
}

QString N::TaiwanEdit::TaiwanString(void)
{
  QString        t                                     ;
  TaiwanCalendar NX                                    ;
  int            Y                                     ;
...
bool N::TaiwanEdit::madeChange(const QString & input)
{
...
void N::TaiwanEdit::textChanged(const QString & text)
{
  QLineEdit * le = lineEdit ( )  ;
  if (IsNull(le)) return         ;
  int p = le->cursorPosition()   ;
